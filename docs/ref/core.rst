...
******************************************
@translation/core - The core i18n functionality
******************************************

``@translation/core`` package provides the main i18n object which manages message catalogs,
...
``@translation/core`` package exports the global instance of ``i18n`` object. Simply import
it and use it:
...
.. js:function:: setupI18n([options])
   ...
   .. important:: You don't need to setup i18n instance
      ...
      In most cases you can use the global ``i18n`` object exported from ``@translation/core``
      directly.
