...
from the ``@translation/core`` package.
...
1. Install ``@translation/cli``, ``@translation/macro``, ``babel-plugin-macros`` and Babel core
   packages as a development dependencies and ``@translation/core`` as a runtime dependency:

   .. code-block:: shell

      npm install --save-dev @translation/cli @translation/macro babel-plugin-macros @babel/core
   ...
   .. code-block:: shell
      ...
      yarn add --dev @translation/cli @translation/macro babel-plugin-macros @babel/core
...
.. code-block:: js
   ...
   import { t, select, plural } from "@translation/macro"
